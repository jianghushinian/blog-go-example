...
func (x *HelloRequest) GetDuration() string {
	if x != nil {
		return x.Duration
	}
	return ""
...
var file_pb_helloworld_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x26, 0x0a, 0x0a, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
...
func file_pb_helloworld_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_helloworld_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pb_helloworld_proto_msgTypes[1].Exporter = func(v any, i int) any {
